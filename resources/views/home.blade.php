...
<div class="d-flex flex-column h-100 align-items-center">
            ...
            @if(Session::has('loginid'))<a href="/newpost" class="w-50" >
            <button type="button" class="btn btn-primary btn-lg btn-block w-100 my-5 d-flex justify-content-center align-items-center"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-lg me-2" viewBox="0 0 16 16">
